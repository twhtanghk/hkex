...
(function() {
  ...
  params = function(el, firstPage = false) {
    var keys, ret;
  ...
  HKEXNew = (function() {
    class HKEXNew {
      ...
      $fetch() {
        return http.postAsync(HKEXNew.$urlRoot[this.lang], this.params).then((res) => {
          this.hasNext = cheerio("input[name='ctl00$btnNext']", res.body).length !== 0;
